...
function getGato() {
    ...
    var inputGato = document.getElementById('myInput').value.toLowerCase();  // toLowerCase(); deixa dado todo munisculo
    ...
    for (var i = 0; meusGatos.gato.length > i; i++) {
        ...
        if(inputGato == cat.nome.toLowerCase()){
            ...
            cardGato.querySelector('h1').innerHTML = "Não encontramos o gatinho :(";
        }
    }
}
